         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title=" انقر هنا لتحديد كافة الالعاب في قسم \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'عنوان اللعبه';
   var tocTool1 = 'انقر ل فرز حسب العنوان';
   var tocHead2 = 'تاريخ اللعبه';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">جميع الالعاب ' + postTitle.length + ' كاملة<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">عرض ' + numDisplayed + ' العاب في قسم \'';
      tocNote += postFilter + '\' من '+ postTitle.length + ' اجمالي الالعاب<br/></span>';
   }
