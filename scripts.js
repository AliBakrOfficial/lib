$(document).ready(function () {
    ...
    $(".menu .menu-img").on({
        mouseenter: function () {
            ...
            img.src = "https://ukieweb.com/envato/ukiecard/style1/assets/img/menu/" + img_name + ".gif?t=" + new Date().getTime();
        ...
        mouseleave: function () {
            var $div = $(this);
            var img_name = $div.attr("data-img-name");
            var src = "https://ukieweb.com/envato/ukiecard/style1/assets/img/menu/" + img_name + ".png";
            $div.attr("src", src);
